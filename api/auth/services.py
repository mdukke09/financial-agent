...
from models.blacklist import add_token_to_blacklist
...
class AuthService:
    ...
    def logout(jti):
        """
        Cierra la sesión añadiendo el token a la lista negra
        
        Args:
            jti (str): JWT ID del token a invalidar
        ...
        try:
            ...
            add_token_to_blacklist(jti, JWT_ACCESS_TOKEN_EXPIRES)
